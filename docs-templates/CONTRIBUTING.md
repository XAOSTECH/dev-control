...
2. Clone your fork: `git clone https://github.com/YOUR_USERNAME/{{REPO_SLUG}}.git`
3. Add upstream remote: `git remote add upstream {{REPO_URL}}.git`
...
Feel free to open a [Discussion]({{REPO_URL}}/discussions) for questions or ideas.
