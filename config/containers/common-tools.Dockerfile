# ============================================================================
# Common tools: system tooling shared by all categories (appended before categories)
# ============================================================================
#
# Provides: GitHub CLI, nvm/Node.js, PATH setup
# Used by: --base builds (all categories), concatenated before category Dockerfiles
#
